...
# Bug Description: If player's first move is not over the board, then the game crashes: "UnboundLocalError: local variable 'column' referenced before assignment"
