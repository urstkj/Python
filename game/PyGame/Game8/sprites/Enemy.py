...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, enemy_type):
        ...
        self.imgs = ['./resource/imgs/game/enemy_yellow.png', './resource/imgs/game/enemy_red.png', './resource/imgs/game/enemy_pink.png', './resource/imgs/game/enemy_blue.png']
        self.image = pygame.image.load(self.imgs[enemy_type])
